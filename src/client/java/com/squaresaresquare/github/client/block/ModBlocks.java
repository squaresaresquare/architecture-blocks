package com.squaresaresquare.github.client.block;
...
import com.squaresaresquare.github.client.block.custom.*;
...
public class ModBlocks {
    ...
    private static ResourceKey<@NotNull Block> keyOfBlock(String name) {
        return ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(ArchitectureBlocksClient.MOD_ID, name));
    }
