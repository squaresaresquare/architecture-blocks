package com.squaresaresquare.github.client.painting;
...
public class ModPaintings {
    ...
    public static final ResourceKey<@NotNull PaintingVariant> DINING_ROOM_SONG_CONTEST_RK = create("dining_room_song_contest");
    ...
    public static void bootstrap(BootstrapContext<@NotNull PaintingVariant> context) {
        ...
        ArchitectureBlocksClient.LOGGER.info("Display context {}\n", context.toString());
        ...
        ArchitectureBlocksClient.LOGGER.info("Display context {}\n", context.toString());
        register(context, MALCOLM_AND_MARGARET_AT_QUEENSFERRY_RK, 3, 5, "The Landing of St Margaret at Queensferry", "Ferdinand Piloty");
        ArchitectureBlocksClient.LOGGER.info("Display context {}\n", context.toString());
        register(context, THE_ARRIVAL_OF_LOHENGRIN_IN_ANTWERP_RK, 4, 2, "The Arrival of Lohengrin in Antwerp", "Ferdinand Piloty");
        ArchitectureBlocksClient.LOGGER.info("Display context {}\n", context.toString());
        register(context, UNDER_THE_LINDON_RK, 6, 4, "Tristan and Isolde under the lindon", "Ferdinand Piloty");
        ArchitectureBlocksClient.LOGGER.info("Display context {}\n", context.toString());
        register(context, BEDROOM_LOVE_POTION_RK, 5, 8, "The love potion", "Ferdinand Piloty");
        ArchitectureBlocksClient.LOGGER.info("Display context {}\n", context.toString());
        ...
        ArchitectureBlocksClient.LOGGER.info("Display context {}\n", context.toString());
        register(context, DINING_ROOM_SONG_CONTEST_RK, 5, 6, "Hermann of Thuringia helping to represent the poem of a minstrel", "Ferdinand Piloty");
        ArchitectureBlocksClient.LOGGER.info("Display context {}\n", context.toString());
        register(context, PARZIFAL_RK, 4, 6, "Parzifal", "Ferdinand Piloty");
        ArchitectureBlocksClient.LOGGER.info("Display context {}\n", context.toString());
        register(context, PARZIFALS_FIGHT_RK, 5, 7, "Parzifals battle with the Red Knight", "Ferdinand Piloty");
        ArchitectureBlocksClient.LOGGER.info("Display context {}\n", context.toString());
    ...
    private static ResourceKey<@NotNull PaintingVariant> create(final String id) {
        return ResourceKey.create(Registries.PAINTING_VARIANT, Identifier.fromNamespaceAndPath(ArchitectureBlocksClient.MOD_ID, id));
    }
    ...
    private static void register(final BootstrapContext<@NotNull PaintingVariant> context, final ResourceKey<@NotNull PaintingVariant>
        ...
        ArchitectureBlocksClient.LOGGER.info("----------- get context info for {} -----------",title);
        ArchitectureBlocksClient.LOGGER.info(context.lookup(key.registryKey()).toString());
        ArchitectureBlocksClient.LOGGER.info("--------------------------------------------------------");
