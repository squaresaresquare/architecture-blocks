...
public class ModBlocks {
    ...
    public static final Block COPPER_POT_BLOCK = register(
            "copper_pot",
            CopperPotBlock::new,
            BlockBehaviour.Properties.of().sound(SoundType.DEEPSLATE)
                    .noOcclusion()
    ...
    public static final Block COPPER_POT2_BLOCK = register(
            "copper_pot2",
            CopperPot2Block::new,
            BlockBehaviour.Properties.of().sound(SoundType.DEEPSLATE)
                    .noOcclusion()
    ...
    public static final Block OVEN_FRONT_BLOCK = register(
            "oven_front",
            OvenFrontBlock::new,
            BlockBehaviour.Properties.of().sound(SoundType.DEEPSLATE)
                    .noOcclusion()
    ...
    public static final Block OVEN_LEFT_BLOCK = register(
            "oven_left",
            OvenLeftBlock::new,
            BlockBehaviour.Properties.of().sound(SoundType.DEEPSLATE)
                    .noOcclusion()
    ...
    public static final Block OVEN_RIGHT_BLOCK = register(
            "oven_right",
            OvenRightBlock::new,
            BlockBehaviour.Properties.of().sound(SoundType.DEEPSLATE)
                    .noOcclusion()
