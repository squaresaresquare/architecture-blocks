...
import com.squaresaresquare.github.block.entity.custom.LeftEndCapBlockEntity;

public class LeftEndCapBlockEntityRenderer implements BlockEntityRenderer<@NotNull LeftEndCapBlockEntity, @NotNull LeftEndCapBlockEntityRenderState> {
