...
import com.squaresaresquare.github.block.entity.custom.MarblePlinthBlockEntity;

public class MarblePlinthBlockEntityRenderer implements BlockEntityRenderer<@NotNull MarblePlinthBlockEntity, @NotNull MarblePlinthBlockEntityRenderState> {
